		...
		<tbody>
			{#each data.list as tipoMateriaPrima}
				<tr class="align-middle">
					...
					<td class="w-2/12"></td>
					<td class="w-1/12">
						<a class="my-2 btn-icon btn-icon-md variant-soft-secondary mr-5" href="/materias-primas/edit/{tipoMateriaPrima.id}">
						<i class="bx bx-edit place-self-center text-2xl"></i></a>
						<button on:click={() => eliminar(tipoMateriaPrima.id)} class="my-2 btn-icon btn-icon-md variant-soft-secondary">
